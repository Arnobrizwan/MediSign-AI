...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new co.daily.daily_flutter.DailyFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin daily_flutter, co.daily.daily_flutter.DailyFlutterPlugin", e);
    }
    try {
